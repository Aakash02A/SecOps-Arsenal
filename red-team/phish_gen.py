...
<body>
    ...
    <!-- ============================================================ -->
    <div style="background-color: #fff3cd; border: 2px solid #ffc107; padding: 10px;
        margin-bottom: 15px; font-family: monospace; font-size: 12px; color: #856404;
        text-align: center;">
        ⚠️ SIMULATION — This is an educational phishing template generated by
        SecOps-Arsenal. Not a real security alert.
    </div>
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{phishing_url}" style="background-color: #0275d8; color: white;
                padding: 12px 25px; text-decoration: none; border-radius: 4px;
                font-weight: bold;">Verify Account Now</a>
        </div>
